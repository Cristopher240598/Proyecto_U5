        ...
        <div class="container">
            ...
            <form class="formulario" enctype="multipart/form-data" action="create-movie.php" method="POST">
                <div class="form-group">
                    ...
                    <input id="titulo" name="titulo" class="form-control" type="text" value="<?php echo htmlspecialchars($titulopeli) ?>" autofocus="autofocus">
                </div>
                <div class="form-group">
                    <label for="reparto">Reparto</label>
                    <input id="reparto" name="reparto" class="form-control" type="text" value="<?php echo htmlspecialchars($repartopeli) ?>">
                </div>
                <div class="form-group">
                    <label for="director">Director</label>
                    <input id="director" name="director" class="form-control ancho-disquera" type="text" value="<?php echo htmlspecialchars($directorpeli) ?>">
               </div>
                <div class="form-group">
                    <label for="genero">Género</label>
                    <select id="genero" name="genero" class="form-control ancho-genero" value="<?php echo htmlspecialchars($categoriapeli) ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea id="descripcion" name="descripcion" class="form-control altura-desc" ><?php echo htmlspecialchars($descripcionpeli) ?></textarea>
                </div>
                <div class="form-group d-flex flex-column">
                    <label for="imagen">Imagen</label>
                    <input id="imagen" name="imagen" type="file" value="<?php echo htmlspecialchars($filename) ?>">
                </div>
           </form>
        </div>
    </section>
