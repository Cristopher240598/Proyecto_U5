        ...
        <div class="container">
            ...
            <form class="formulario" action="create-headphones.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input class="form-control ancho-marca" type="text" name="marca" id="marca" onchange="valtexto200('marca')" maxlength="200" required>
                </div>
                <div class="form-group">
                    <label for="modelo">Modelo</label>
                    <input class="form-control ancho-artista" type="text" name="modelo" id="modelo" autofocus onchange="valtexto200('modelo')" maxlength="200" required>
                </div>
                <div class="form-group">
                    <label for="potencia">Potencia máxima (mW)</label>
                    <input class="form-control ancho-disquera" type="number" name="potencia" id="potencia" onchange="valpotencia('potencia')" autofocus="" max="99999" min="1" required>
                </div>
                <div class="form-group">
