        ...
        <div class="container">
            ...
            <form class="formulario" enctype="multipart/form-data" action="update-movie.php?id=<?php echo $peliculas['id'] ?>" method="POST">
                <div class="form-group">
                    <label>Título</label>
                    <input class="form-control" type="text" name="titulo" id="titulo" value="<?php echo htmlspecialchars($peliculas['titulo']); ?>" autofocus>
                </div>
                <div class="form-group">
                    <label>Reparto</label>
                    <input class="form-control" type="text" name="reparto" id="reparto" value="<?php echo htmlspecialchars($peliculas['reparto']); ?>" autofocus>
                </div>
                <div class="form-group">
                    <label>Director</label>
                    <input class="form-control ancho-disquera" type="text" name="director" id="director" value="<?php echo htmlspecialchars($peliculas['director']); ?>" autofocus>
                </div>
                <div class="form-group">
                    <label>Género</label>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control altura-desc" id="descripcion" name="descripcion"><?php echo htmlspecialchars($peliculas['descripcion']); ?></textarea>
                </div>
